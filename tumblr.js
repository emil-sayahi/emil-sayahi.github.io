! function(e, t) {
    ...
    ue.Animation = ue.extend(P, {
        ...
        var e, n = ue.timers,
            r = 0;
        for (Kt = ue.now(); n.length > r; r++) e = n[r], e() || n[r] !== e || n.splice(r--, 1);
...
! function(t, i, s) {
    ...
    n.special.smartresize = {
        ...
        layout: function(t, i) {
            ...
            for (s = 0, e = this.styleQueue.length; s < e; s++) h = this.styleQueue[s], h.$el[a](h.style, r);
        ...
        _placeBrick: function(t) {
            ...
            if (s = Math.ceil(a.outerWidth(!0) / this.columnWidth), s = Math.min(s, this.cols), 1 === s) n = this.colYs;
                ...
                for (e = this.cols + 1 - s, n = [], h = 0; h < e; h++) o = this.colYs.slice(h, h + s), n[h] = Math.max.apply(Math, o);
        ...
        function e(t) {
            var n = t.target;
            n.src !== a && i.inArray(n, r) === -1 && (r.push(n), --h <= 0 && (setTimeout(s), o.unbind(".imagesLoaded", e)))
        }
        var n = this,
...
! function(t, i) {
    var e = {
            init: function() {
                this.globals(), this.devices(), this.like_button(), this.in_iframe(), this.like_button(), this.link_color(), this.description_color(), t(".header-image").length && this.load_header(), Function("/*@cc_on return document.documentMode===10@*/")() && i.$body.addClass("ie10"), this.init_related_posts_cta(), this.init_no_likes_text(), this.init_no_posts_text(), this.init_no_following_text()
            },
            globals: function() {
                i.$win = t(window), i.$doc = t(document), i.$notes = t(".notes-wrapper"), i.$notesInner = t(".notes"), i.$body = t("body"), i.$win_body = t("html, body")
            },
            in_iframe: function() {
            ...
            load_header: function() {
                ...
                if (i.$body.hasClass("iframe") || i.$body.hasClass("touch")) e.css({
                    opacity: 1
                }).addClass("loaded");
                else {
            ...
            link_color: function() {
                ...
                t.s < .2 && t.v > .8 && (i.$body.addClass("light-accent"), e.s < .2 && e.v > .8 && i.$body.addClass("light-on-light")), t.v < .2 && e.v < .2 && i.$body.addClass("dark-on-dark")
            },
            ...
            devices: function() {
                ...
                this.supports_app_nag = !1, this.is_touch_device() && (i.$body.addClass("touch"), i.$body.hasClass("permalink") || setTimeout(function() {
                    window.scrollTo(0, 1)
                }, 1));
                var s = (e.match(/Android\s([0-9\.]*)/) || [])[1];
                e.match(/(iPhone|iPod|iPad)/) ? (this.ios(), this.supports_app_nag = !0) : s && (this.supports_app_nag = !0, i.$body.addClass("android"), parseFloat(s) < 4.4 && i.$body.addClass("android-lt-4-4")), this.supports_app_nag && this.supports_local_storage() && "true" !== localStorage.getItem("has-seen-app-nag") && (i.$body.addClass("catch-share-events"), this.prepare_app_nag()), t("#page").on("click", "a.open-in-app", t.proxy(function(i) {
                    i.preventDefault();
                    var e, s, o, n = t(i.currentTarget),
                        a = n.data("post");
                    n.hasClass("related-post-cta") && (e = "blog_related_posts_cta", s = n.data("cta-variant"), o = t(".related-posts > article").length), this.open_in_app(a, e, s, o)
                }, this))
            },
            ...
            prepare_app_nag: function() {
                ...
                var e = t(".app-nag");
                e.on("click", ".app-nag-close-button", t.proxy(function(t) {
                    i.$body.removeClass("show-app-nag"), this.close_app_nag(!1)
                }, this)), e.on("click", ".app-nag-app-store-deny", t.proxy(function(t) {
                    this.close_app_nag(!1)
                }, this)), e.on("click", ".app-nag-app-store-link", t.proxy(function(i) {
                    this.close_app_nag(!0), this.open_in_app(t(i.currentTarget).data("id"), "blog_engagement_popover")
                }, this))
            },
            open_app_nag: function(e) {
                i.$body.addClass("show-app-nag"), t(".app-nag-app-store-link").data("id", e)
            },
            close_app_nag: function(e) {
                e === !1 && (t(".catch-share-events").off("click.shareEvents"), localStorage.setItem("has-seen-app-nag", !0)), i.$body.removeClass("show-app-nag catch-share-events")
            },
            ios: function() {
            ...
            open_in_app: function(i, e, s, o) {
                ...
                var n = "//www.tumblr.com/open/app?referrer=" + e + "&variant=" + s + "&num_related_posts=" + o + "&app_args=" + encodeURIComponent("blog?blogName=") + t("body").data("urlencoded-name");
                return i && (n += encodeURIComponent("&postID=" + i)), this.is_ios ? void this.open_in_app_or_store(n, e) : void(document.location = n)
            },
            open_in_app_or_store: function(t, i) {
                ...
                var s = document.getElementById("app_protocol_check") || document.createElement("iFrame");
            ...
            hex_to_rgb: function(t) {
                t = (t + "").replace(/[^0-9a-f]/gi, ""), t.length < 6 && (t = t[0] + t[0] + t[1] + t[1] + t[2] + t[2]);
                var i = "([a-f\\d]{2})",
            ...
            rgb_to_hsv: function(t, i, e) {
                ...
                return n ? o === t ? a.h += (i - e) / n : o === i ? a.h += 2 + (e - t) / n : a.h += 4 + (t - i) / n : a.h = 0, a.h = 60 * a.h % 360, a
            },
            hsv_to_rgb: function(t, i, e) {
                ...
                if (i) {
                    ...
                    a < 1 ? (s = r, o = l) : a < 2 ? (s = l, o = r) : a < 3 ? (o = r, n = l) : a < 4 ? (o = l, n = r) : a < 5 ? (n = r, s = l) : (n = l, s = r), s += h, o += h, n += h
                } else s = o = n = e;
                return {
                    r: Math.round(255 * s),
                    g: Math.round(255 * o),
            ...
            hex_to_hsv: function(e) {
                e = (e + "").replace(/[^0-9a-f]/gi, ""), e.length < 6 && (e = e[0] + e[0] + e[1] + e[1] + e[2] + e[2]);
            ...
            hex_brightness: function(t, i) {
                ...
                var e, s, o, n = parseInt(t, 16),
                    a = i < 0 ? 0 : 255,
                    r = i < 0 ? -i : i,
                    h = n >> 16,
                    l = n >> 8 & 255,
                    c = 255 & n;
                return e = Math.round((a - h) * r) + h, s = Math.round((a - l) * r) + l, o = Math.round((a - c) * r) + c, "#" + (16777216 + 65536 * e + 256 * s + o).toString(16).slice(1)
            },
            ...
            debounce: function(i, e) {
                ...
                return function() {
                    var o = arguments;
                    clearTimeout(s), s = setTimeout(t.proxy(function() {
                        i.apply(this, o)
                    }, this), e)
                }
            }
        ...
        o = {
            ...
            event_loop: function() {
                ...
                }, this)), t(".notes-wrapper .notes").on("scroll.Eventor:next-frame", t.proxy(function() {
                    this.tick || (s(t.proxy(this.popover_frame, this)), this.tick = !0)
                }, this))
            },
        ...
        n = function(i, e) {
            return this instanceof n ? (this.el = "string" == typeof i ? t(i).get(0) : i, this.$el = t(i), this.options = e, this.metadata = this.$el.data("plugin-options"), this.config = t.extend({}, n.defaults, this.options, this.metadata), this.trigger = this.config.trigger || !1, this.$trigger = t(this.config.trigger) || this.$el, this.bind_events(), this) : new n(i, e)
        };
    n.prototype = {
        ...
        hide: function(e) {
            i.Popmenu.hide_all(), this.leave_delay = setTimeout(t.proxy(function() {
    ...
    var a = function(e, s) {
        this.$el = t(e), this.options = t.extend({
            animate_opacity: !1,
            animate_position: !0,
            inertia: .3,
            opacity_inertia: .4
        }, s || {}), this.inertia = this.options.inertia, i.$win.on("Eventor:scroll", t.proxy(this.__window_scroll, this))
    };
    a.prototype = {
    ...
    var r = function(i, e, s) {
        return this instanceof r ? (this.el = "string" == typeof i ? t(i).get(0) : i, this.$el = t(i), this.config = t.extend({}, r.defaults, e), this.callback = s || function() {}, this.successes = 0, this.errors = 0, this.items = [], this.get_items(), this) : new r(i, e, s)
    };
    r.prototype = {
        get_items: function() {
            this.items = this.el.querySelectorAll(this.config.selector), this.items.length || this.callback();
            for (var i = 0, e = this.items.length; i < e; i++) this.re_load(t(this.items[i]))
        },
        re_load: function(i) {
    ...
    var h = function(i, e) {
        ...
        }, this.bind_events(), h.register(this), this) : new h(i, e)
    };
    h.prototype = {
        __document_click: function(i) {
            var e = t(i.target);
            this.$popover && this.$popover.hasClass("active") && !this.$el.has(e.parents(this.config.container)).length && !e.is(this.config.ignore) && this.hide()
        },
        __close_click: function(t) {
            this.hide()
        },
        __trigger_click: function(i) {
            i.preventDefault(), this.$trigger = t(i.currentTarget), this.options && this.options.hash && (document.location.hash = this.options.hash), this.$container = this.$trigger.parents(this.config.container), this.$glass = this.$container.siblings(this.config.glass), this.$popover = this.$trigger.siblings(this.config.popover), this.$popover.length || (this.$popover = this.$trigger.parents("footer").find(this.config.popover)), this.$popover.hasClass("active") ? this.hide() : this.show()
        },
        ...
        bind_events: function() {
            this.$el.on("touchstart click", this.trigger, this.events.trigger_click), this.$el.on("touchstart click", this.close_button, this.events.close_click), this.$el.on("mouseenter", this.popover, this.events.popover_mouseenter), this.$el.on("mouseleave", this.popover, this.events.popover_mouseleave), i.$doc.on("click", this.events.document_click)
        },
        unbind_events: function() {
            this.$el.off("click", this.trigger, this.events.trigger_click), this.$el.off("mouseenter", this.popover, this.events.popover_mouseenter), this.$el.off("mouseleave", this.popover, this.events.popover_mouseleave), i.$doc.off("click", this.events.document_click)
        },
        destroy: function() {},
        show: function() {
            this.$glass && this.$glass.addClass("active"), this.$popover.parents("article").addClass("visible"), this.$popover.addClass("show"), this.$trigger.addClass("show"), setTimeout(t.proxy(function() {
                i.$body.addClass(this.config.body_active_class), this.$trigger.addClass("active"), this.$container.addClass("active"), this.$popover.addClass("active"), this.scroll_offset = i.$win.scrollTop(), this.config.close_on_scroll && i.$win.on("Eventor:scroll", this.events.offset_scroll)
            }, this), 10)
        },
        hide: function(e) {
            ...
            i.$win.off("Eventor:scroll", this.events.offset_scroll), i.$body.removeClass(this.config.body_active_class), history.replaceState("", document.title, window.location.pathname + window.location.search), this.$glass && this.$glass.removeClass("active"), this.$container && this.$container.removeClass("active"), o.removeClass("active"), s.removeClass("active"), s.each(function() {
    ...
    var l = {
            __popover_scroll: function() {
                i.DONE_LOADING_NOTES && this.unbind_events(), this._near_bottom() && !i.LOADING_NOTES && this.load_notes()
            },
            _near_bottom: function() {
                return i.$notesInner[0].scrollHeight - i.$notesInner.scrollTop() < 3 * i.$notes.height()
            },
            init: function() {
                i.LOADING_NOTES = !1, this.events = {
            ...
            load_notes: function() {
                i.LOADING_NOTES || (i.LOADING_NOTES = !0, t(".more_notes_link").trigger("click"))
            }
        },
        c = {
            $elements: [],
            ...
            __hover_begin: function(i) {
                ...
                if (e) {
                    ...
                    this.get_card_html(e, function(e) {
                        s.html(e), t(i.target).parents("article").append(s.get(0)), s.fadeIn()
                    })
                }
            },
            ...
            get_card_html: function(i, e) {
                ...
                return s[i] ? e(s[i]) : void t.get("/blog_card/" + i).done(function(t) {
                    return s[i] = t, e(t)
                }).fail(function() {
                    return !1
                })
            ...
            init: function() {
                return !!i.NU_OPTICA_BLOG_CARDS && (this.$card_holder = t("<div></div>"), this.$card_holder[0].style.display = "none", this.$card_holder.addClass("blog-card-popover"), this.events = {
            ...
            bind_triggers: function(t) {
                ...
                t.on("mouseenter", this.events.hover_begin), t.on("mouseleave", this.events.hover_stop)
            },
            bind_events: function() {
                this.bind_triggers(i.$win_body), this.$card_holder.on("mouseenter", this.events.hover_card_begin), this.$card_holder.on("mouseleave", this.events.hover_card_stop)
            }
        },
        _ = {
            init: function() {
                return this._draggable = {
                    ...
                    dragX: 0,
                    currentX: 0
                }, this.$inlineNav = t(".inline-nav"), this.$navItems = t(".inline-nav .nav-item"), this.$links = t(".inline-nav a"), this.events = {
                    ...
                    windowResize: t.proxy(i.Utils.debounce(this.__window_resize, 100), this)
                }, this.docEvents = {
                    dragMove: t.proxy(this.__drag_move, this),
                    dragReset: t.proxy(this.__drag_reset, this),
                    dragCheckMouseOut: t.proxy(this.__drag_check_mouse_out, this)
                }, this._bind_events(), this._drag_setup(), this
            },
            _drag_setup: function() {
                this._drag_overflowing() && this.$inlineNav.addClass("draggable")
            },
            _bind_events: function() {
                this.$inlineNav.on("mousedown", this.events.dragStart), this.$inlineNav.on("mousemove", this.events.dragMove), this.$inlineNav.on("mouseup", this.events.dragEnd), this.$links.on("click", this.events.dragLinkHandler), i.$win.on("resize orientationchange", this.events.windowResize)
            },
            _drag_bind_doc_events: function() {
                i.$doc.on("mousemove.linksDraggable", this.docEvents.dragMove), i.$doc.on("mouseup.linksDraggable", this.docEvents.dragReset), i.$doc.on("mouseout", this.docEvents.dragCheckMouseOut)
            },
            _drag_unbind_doc_events: function() {
                i.$doc.off("mousemove.linksDraggable"), i.$doc.off("mouseup.linksDraggable"), i.$doc.off("mouseout")
            },
            ...
            _drag_reset_position: function() {
                ...
                t > 0 ? (this._drag_set(0), this._draggable.currentX = 0) : t < i ? (this._drag_set(i), this._draggable.currentX = i) : this._draggable.currentX = t
            },
            __drag_check_mouse_out: function(t) {
                var i = t.relatedTarget || t.toElement;
                i && "HTML" !== i.nodeName && "IFRAME" !== i.nodeName || this.__drag_end(t)
            },
            __drag_link_handler: function(t) {
                this._draggable.dragging && (t.stopPropagation(), t.preventDefault())
            },
            __drag_start: function(t) {
                t.preventDefault(), this._draggable.dragging || this._draggable.pointerDown || !this._drag_overflowing() || (this._draggable.pointerDown = !0, this.$inlineNav.addClass("dragging"), this._draggable.pageX = "pageX" in t ? t.pageX : t.originalEvent.touches[0].pageX, this._drag_bind_doc_events())
            },
            __drag_move: function(t) {
                if (this._draggable.pointerDown) {
                    t.preventDefault(), t.stopPropagation(), this._draggable.dragging = !0, this._draggable.dragX = ("clientX" in t ? t.clientX : t.originalEvent.touches[0].clientX) - this._draggable.pageX;
                    var i = this._draggable.currentX + this._draggable.dragX;
                    this._drag_set(i)
                }
            },
            __drag_end: function(i) {
                i.preventDefault(), i.stopPropagation(), setTimeout(t.proxy(this.__drag_reset, this), 100)
            },
            __drag_reset: function() {
                (this._draggable.dragging || this._draggable.pointerDown) && (this._draggable.dragging = !1, this._draggable.pointerDown = !1, this._drag_reset_position(), this._draggable.dragX = 0, this.$inlineNav.removeClass("dragging"), this._drag_unbind_doc_events())
            },
            __window_resize: function() {
                this._drag_overflowing() ? this.$inlineNav.hasClass("draggable") || this.$inlineNav.addClass("draggable") : (this.$inlineNav.removeClass("draggable"), this.$navItems.removeAttr("style"), this._draggable.currentX = 0, this._draggable.pageX = 0)
            }
        },
        /*
        d = {
            ...
            determine_fixed_state: function() {
                ...
                i.$win.scrollTop() >= s && !this.$navbar.hasClass("nav-fixed") ? (this.$navbar.addClass("nav-fixed"), this.$posts.css("margin-top", "+=" + o)) : i.$win.scrollTop() < s && this.$navbar.hasClass("nav-fixed") && (this.$navbar.removeClass("nav-fixed"), this.$posts.css("margin-top", "-=" + o))
            },
            init: function(i) {
                return this.iframeHeight = i ? i.unifiedIframeHeight : 54, this.$navbar = t(".nav-wrapper"), this.$posts = t("#posts"), this.$inlineNav = t(".inline-nav"), this.$headerWrapper = t(".header-wrapper"), this.events = {
                    scroll: t.proxy(this.__window_scroll, this)
                }, this.bind_events(), this.determine_fixed_state(), this
            },
            bind_events: function() {
        ...
        */
        p = function(e, s) {
            return this instanceof p ? (this.el = "string" == typeof e ? t(e).get(0) : e, this.$el = t(e), this.config = t.extend({}, p.defaults, s), this.config.$pagination || this.config.$pagination.length ? (this.current_page = this.config.$pagination.data("current-page"), this.next_page_number = this.current_page + 1, this.total_pages = this.config.$pagination.data("total-pages"), this.base_url = this.config.$pagination.attr("href"), this.base_url && (this.base_url = this.base_url.substring(0, this.base_url.lastIndexOf("/")) + "/"), this.loading_data = !1, this.is_scrolling = !1, this.body_timeout = -1, this.cache_selectors(), this.bind_events(), this.config.endless_scrolling && this.config.$pagination.length ? (this.config.$pagination.addClass("invisible"), this.init = !0) : this.init = !1, (i.$body.hasClass("touch") || this.$html.hasClass("lt-ie9")) && (i.GRID_LAYOUT = !1, this.is_grid_layout = !1, i.$body.removeClass("grid")), this.update_body(), this.set_body_type(), this.updateMedia(), i.GRID_LAYOUT || this.update_spotify(), i.$body.hasClass("narrow") && this.upscale_images(), p.register(this), this) : void 0) : new p(e, s)
        };
    p.prototype = {
        __document_keydown: function(e) {
            var s = e.charCode ? e.charCode : e.keyCode,
                o = e ? e.target : window.event.srcElement;
            t(o).is("input:focus") || (27 === s && i.Popmenu.hide_all(), 190 === s && i.$win_body.animate({
                scrollTop: 0
            }), this.is_grid_layout || i.$body.hasClass("permalink") || (74 === s ? this.next_post() : 75 === s && this.previous_post()))
        },
        __window_resize: function() {
            this.set_body_type(), this.is_grid_layout || this.update_spotify(), this.updateMedia()
        },
        __window_scroll: function() {
            i.$body.hasClass("touch") && this.update_body(), this.is_scrolling || (i.$body.addClass("is-scrolling"), this.is_scrolling = !0), clearTimeout(this.body_timeout), this.body_timeout = setTimeout(t.proxy(function() {
        ...
        _throttle: function(t, i, e) {
            ...
            return function() {
                var n = e || this,
                    a = +new Date,
                    r = arguments;
                s && a < s + i ? (clearTimeout(o), o = setTimeout(function() {
                    s = a, t.apply(n, r)
                }, i)) : (s = a, t.apply(n, r))
            }
        },
        ...
        _in_view: function(t) {
            var e, s = i.$win.scrollTop();
            this.window_height = this.window_height || i.$win.height();
            var o = s + this.window_height;
            return e = this._get_post_bounds(t), e || (e = this._set_post_bounds(t)), !(e.bottom + this.window_height < s || e.top > o + this.window_height)
        },
        _snooze: function(t) {
            t.addClass("snooze")
        },
        ...
        _get_next_page: function() {
            ...
            i.done(t.proxy(this._append_new_items, this)), i.fail(t.proxy(this._failed, this))
        },
        _failed: function() {
            this.hide_loader(!0)
        },
        _append_new_items: function(e) {
            var s = "#posts .main",
                ...
                n = o.children(),
                a = [];
            n.each(t.proxy(function(i, e) {
                var s = t(e).find(".like_button").data("post-id");
                s && a.push(s)
            }, this)), c.bind_triggers(o), t(s).append(n), this.updateMedia(o), i.GRID_LAYOUT && this.is_grid_layout || i.$body.hasClass("following-page") || i.$body.hasClass("likes-page") ? n.imagesLoaded(t.proxy(function() {
                o.iframesLoaded({
                    selector: ".post-content iframe"
                }, t.proxy(function() {
                    this.config.$target.masonry("appended", n, !0), this.loading_data = !1, this.animate_posts(n), this.hide_loader()
                }, this))
            }, this)) : (this.loading_data = !1, this.update_spotify(o), i.$body.hasClass("narrow") && this.upscale_images(o), n.fadeTo(300, 1), this.hide_loader()), a && a.length > 0 && window.Tumblr.LikeButton.get_status_by_post_ids(a), window.ga && window.ga("send", "pageview", {
                page: "/page/" + this.next_page_number,
                title: "Index Page -- Ajax Load"
            }), this.current_page = this.next_page_number, this.next_page_number++, i.$win.trigger("next_page_loaded", e)
        },
        cache_selectors: function() {
            this.$html = t("html"), this.$header = t("#header"), this.$posts = t("#posts"), this.$relatedPosts = t(".related-posts")
        },
        animate: function() {
            this.go_to_position && !this.animating && (this.animating = !0, t("html, body").stop().animate({
        ...
        set_body_type: function() {
            !this._slender() || i.$body.hasClass("following-page") || i.$body.hasClass("likes-page") ? (i.$body.removeClass("slender"), (i.GRID_LAYOUT && i.$body.hasClass("index-page") || i.$body.hasClass("following-page") || i.$body.hasClass("likes-page")) && (i.$body.addClass("grid"), this.set_masonry())) : (i.$body.addClass("slender").removeClass("grid"), i.GRID_LAYOUT && this.is_grid_layout && (this.config.$target.css({
                width: "auto"
            }), this.config.$target.masonry("destroy"), this.is_grid_layout = !1))
        },
        update_body: function() {
            this._near_top() ? (i.$body.addClass("top"), i.$body.removeClass("below-header")) : (i.$body.removeClass("top"), i.$body.addClass("below-header"))
        },
        ...
        bind_events: function() {
            this.$el.on("Eventor:scroll", t.proxy(this.__window_scroll, this)), this.$el.on("resize orientationchange", t.proxy(i.Utils.debounce(this.__window_resize, this.config.resizeDelay), this)), i.$doc.on("keydown", t.proxy(this.__document_keydown, this))
        },
        update_spotify: function(i) {
            var e = t(".audio_container").width(),
                s = e + 80,
                o = i && i.length ? t(".spotify_audio_player", i) : t(".spotify_audio_player");
            e > 500 ? o.each(function() {
                t(this).css({
                    width: e,
                    height: s
        ...
        upscale_images: function(i) {
            var e = i && i.length ? t(".photo figure:not(.high-res)", i) : t(".photo figure:not(.high-res)");
            e.each(function() {
                t(this).data("photo-width") > 420 && t(this).addClass("high-res")
            })
        },
        updateMedia: function(i) {
            var e = ".like_toggle, .twitter-tweet, .tumblr-embed, .tumblr_audio_player, .spotify_audio_player, .instagram-media",
    ...
    }, i.Utils = e, i.Eventor = o, i.Popmenu = h, i.Parallaxer = a, i.Drawer = n, i.Pager = p, i.NotesPager = l, i.StickyNav = d, i.DraggableLinks = _, i.BlogCard = c, window.tumblrNotesInserted = function() {
        t(".more_notes_link").length ? i.LOADING_NOTES = !1 : i.DONE_LOADING_NOTES = !0
    }, t(function() {
        i.Utils.init(), i.Eventor.init(), i.BlogCard.init();
        var e = t("body");
        e.hasClass("contain-header-image") ? new i.Parallaxer("body:not(.ie10, .touch) .parallax", {
            animate_opacity: !0,
            animate_position: !1
        ...
        }), t("#page").popmenu(), e.hasClass("permalink") && (t("#page").popmenu({
        ...
        }), "#notes" === document.location.hash && t("#posts .main > article .post-notes").click());
        var o = function(i, e) {
                var s = e.containerEl,
                    o = t("#posts");
                o.each(function() {
        ...
        window.Optica.$win.on("lrec_ads_placeholder_inserted", o), window.Optica.$win.on("lrec_ads_loaded", n), window.Optica.$win.on("init_sticky_nav", function(t, e) {
            i.StickyNav.init(e)
        }), window.Optica.SHOW_NAV && i.DraggableLinks.init(), i.NotesPager.init()
    })
